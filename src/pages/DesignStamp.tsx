...
const DesignStamp = () => {
  ...
  const steps = [
    { id: 'customize', label: t('steps.customize', 'Customize'), completed: currentStep !== 'customize' },
    { id: 'preview', label: t('steps.preview', 'Preview'), completed: currentStep === 'order' },
    { id: 'order', label: t('steps.order', 'Order'), completed: false }
  ];
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                {currentStep !== 'customize' && (
                  <Button
                    ...
                    variant="outline"
                    size="sm"
                    className="flex items-center gap-2 min-h-[44px] text-brand-blue border-brand-blue hover:bg-brand-blue hover:text-white"
                  >
                    <ArrowLeft size={16} />
                ...
                {steps.map((step, index) => (
                  <div key={step.id} className="flex items-center">
                    ...
                    <span className={`ml-2 text-sm font-medium ${
                      index === currentStepIndex ? 'text-brand-red' : 'text-gray-600'
                    }`}>
                      {step.label}
                    </span>
                  </div>
            ...
            <div className="w-full md:w-3/4">
              <div className="mb-6 p-4 bg-white rounded-lg shadow-sm">
                ...
                <select
                  ...
                  className="w-full md:max-w-md px-4 py-3 border rounded-md focus:outline-none focus:ring-2 focus:ring-brand-blue min-h-[44px]"
              ...
              <div className="bg-white rounded-lg shadow-md mb-8">
                {currentStep === 'order' && selectedProduct ? (
                  <div className="p-6">
                    ...
                    <Button
                      ...
                      className="mt-4 bg-brand-red hover:bg-red-700 text-white min-h-[44px]"
                    >
